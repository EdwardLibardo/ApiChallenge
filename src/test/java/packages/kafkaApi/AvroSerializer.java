...
public class AvroSerializer<T extends org.apache.avro.specific.SpecificRecord> implements Serializer<T> {
    ...
    public AvroSerializer(SchemaRegistryClient client) {
            inner = new KafkaAvroSerializer(client);
        }

    public AvroSerializer(SchemaRegistryClient client, Map<String, ?> props) {
