...
public class Song extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public static Song.Builder newBuilder() {
     ...
     */
    public static Song.Builder newBuilder(Song.Builder other) {
        return new Song.Builder(other);
    }

    /**
     * Creates a new Song RecordBuilder by copying an existing Song instance
     */
    public static Song.Builder newBuilder(Song other) {
        return new Song.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Song>
         ...
         * Sets the value of the 'id' field
         */
        public Song.Builder setId(long value) {
         ...
         * Sets the value of the 'album' field
         */
        public Song.Builder setAlbum(java.lang.String value) {
         ...
         */
        public Song.Builder clearAlbum() {
            album = null;
         ...
         * Sets the value of the 'artist' field
         */
        public Song.Builder setArtist(java.lang.String value) {
         ...
         */
        public Song.Builder clearArtist() {
            artist = null;
         ...
         * Sets the value of the 'name' field
         */
        public Song.Builder setName(java.lang.String value) {
         ...
         * Sets the value of the 'genre' field
         */
        public Song.Builder setGenre(java.lang.String value) {
         ...
         */
        public Song.Builder clearGenre() {
            genre = null;
